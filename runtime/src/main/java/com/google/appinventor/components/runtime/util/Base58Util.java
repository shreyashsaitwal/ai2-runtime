...
public class Base58Util {
     ...
     * @throws IOException if the given string is not a valid base58 string
     */
    ...
    /* cribbed from Arrays.java
     * We have a copy here because older devices do not have Arrays.copyOfRange
     */
