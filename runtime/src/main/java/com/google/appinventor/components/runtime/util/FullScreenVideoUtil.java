...
public class FullScreenVideoUtil implements OnCompletionListener,
    ...
    /**
     * @param form    The {@link com.google.appinventor.components.runtime.Form} that
     *                this FullScreenVideoUtil will use.
     * @param handler A {@link android.os.Handler} created on the UI thread. Used for
     ...
     *
     * @param source    The source path to use. The {@link MediaUtil} is used to load the
     *                  source.
     * @param clearSeek If True, the video will start playing at position zero. If False,
