...
public class CustomMediaController extends MediaController implements
     ...
     *
     * @param timeout How long the GUI should be shown for.
     */
    @Override
     ...
     *
     * @param parent The {@link android.view.ViewGroup} to add the CustomMediaController
     *               to.
     * @param params The {@link android.view.ViewGroup.LayoutParams} to use when adding
